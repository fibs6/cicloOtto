...
presion_max = Slider(title="Presion máxima (Pa)", value=35*10**6 , start=3*10**6, end=35*10**6, step=10*10**3)
...
radio_compresion = Slider(title="Radio de compresión", value=8.5, start=2, end=10, step=0.1)
gamma = 1.4
